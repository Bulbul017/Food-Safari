...
public class UploadImageFB extends AppCompatActivity {
    ...
    public void UploadImage() {
        ...
        if (FilePathUri != null) {
            ...
            //String photoURL = Constant.res_owner_pass + "." + GetFileExtension(FilePathUri);
            //Constant.getRes_owner_DP = photoURL;
            //StorageReference storageReference2 = storageReference.child(photoURL);
